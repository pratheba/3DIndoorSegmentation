function write_ply(vertex,face,colorInformation, filename, mode)
...
Data.face.red = colorInformation(:,1);
Data.face.green = colorInformation(:,2);
Data.face.blue = colorInformation(:,3);
% Data.face.red  = {};
% Data.face.green={};
% Data.face.blue = {};
for i=1:size(face,1)
    Data.face.vertex_indices{end+1} = face(i,:)-1;
%     Data.face.red(i) = 255;%colorInformation(i,1);
%     Data.face.green(i) = 0;%colorInformation(i,2);
%     Data.face.blue(i) = 0;%colorInformation(i,3);
%     Data.face.red{end+1} = colorInformation(face(i),1);
%     Data.face.green{end+1} = colorInformation(face(i),2);
%     Data.face.blue{end+1} = colorInformation(face(i),3);
end
